...
public class ImgApp {
    ...
    private static final Logger log = LoggerFactory.getLogger(ImgApp.class);

    private final Environment env;

    public ImgApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(ImgApp.class);
